...
class FillPermissionsForLoaisanpham extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLoaisanpham constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.loaisanpham',
            'admin.loaisanpham.index',
            'admin.loaisanpham.create',
            'admin.loaisanpham.show',
            'admin.loaisanpham.edit',
            'admin.loaisanpham.delete',
            'admin.loaisanpham.bulk-delete',
        ]);
